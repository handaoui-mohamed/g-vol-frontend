...
class FlightsListController {
	// similaire comments are found in accounts list
	...
	getFlightsCount() {
		this.flightService.get({ flightId: "count" }, (data) => {
	...
	/**
	 * map flight company ID to the company
	 */
