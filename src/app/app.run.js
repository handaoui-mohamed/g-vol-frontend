export default
	...
	AccountService.get({ accountId: $window.localStorage['current_account'] }, (account) => {
		$rootScope.currentAccount = $rootScope.currentAccount || account;
		...
		$transitions.onStart({}, (trans) => {
			...
			// we used a global one, and then choose to show it
			$rootScope.hideTopBG = false;
