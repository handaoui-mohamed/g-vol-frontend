...
(function (window, angular, undefined) {
	...
	angular.module('sasrio.angular-material-sidenav', [])
		...
		// (isSelected(section.state) || $state.includes(section.state))
		.run(['$templateCache', function ($templateCache) {
			$templateCache.put('views/ss/menu-link.tmpl.html',
				'<md-button md-no-ink\n' +
				'   ng-class="{\'side-menu-selected\': $state.includes(section.state)}"' +
			...
			$templateCache.put('views/ss/menu-toggle.tmpl.html',
				'<md-button md-no-ink class="md-raised md-primary md-button-toggle"\n' +
